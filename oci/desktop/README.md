...
- Buzzard CUA with its MCP/CLI integration and explicit upstream attribution;
...
`STOCK_SWAY_WINDOW_CONTRACT.md` and checked against the installed distro
packages during image verification.
...
The repository intentionally has no active publisher for images, Debian
packages, or releases at this stage.
