...
use cua_driver_contract::{
    ...
    PressKeyInput, RestoreWindowInput, ScrollInput, SessionStateOutput, SetAgentCursorEnabledInput,
...
macro_rules! desktop_tool_methods {
    ($callback:ident) => {
        $callback! {
            ...
            minimize_window: MinimizeWindowInput,
            maximize_window: MaximizeWindowInput,
            restore_window: RestoreWindowInput,
