...
async fn web_extents_are_physical(
    visited: &[Visited<'_>],
    pid: u32,
    coord: CoordType,
) -> bool {
    ...
    let converted = crate::wayland::physical_rect_to_logical(
        x,
        y,
        width as u32,
        height as u32,
...
mod coord_tests {
    ...
    use super::{
        ...
        rebase_renderer_window_offset, rect_fits_window, screen_extent_rebase,
        select_click_target,
    };
    use atspi::Role;
