...
//! compiled into the bounded artifact embedded by [`crate::cursor::theme_artifact`].
...
pub fn paint_default_theme_with_fill(
    ...
    let theme = crate::cursor::theme_artifact::embedded_default_theme();
    crate::cursor::theme_artifact::paint_compiled_theme_with_tint(
        pm,
        &theme,
        visual,
        anchor_x,
