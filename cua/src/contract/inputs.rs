...
macro_rules! window_action_input {
    ($type_name:ident, $tool_name:literal) => {
        #[derive(Debug, Clone, Serialize, Deserialize, JsonSchema, PartialEq)]
        #[serde(deny_unknown_fields)]
...
window_action_input!(CloseWindowInput, "close_window");
window_action_input!(MinimizeWindowInput, "minimize_window");
window_action_input!(MaximizeWindowInput, "maximize_window");
window_action_input!(RestoreWindowInput, "restore_window");
