...
fn capture_via_xgetimage(xid: u64) -> Result<(String, u32, u32)> {
    ...
    let png = crate::core::image_utils::encode_rgba_to_png(&rgba, w, h)?;
...
pub fn png_dimensions_pub(data: &[u8]) -> Result<(u32, u32)> {
    crate::core::image_utils::png_dimensions(data)
}
...
pub fn screenshot_display_bytes() -> Result<Vec<u8>> {
    screenshot_display_bytes_with_dispatch(
        ...
        crate::platform::wayland::screenshot_display_dispatch,
...
/// [`crate::platform::wayland::screenshot_display_dispatch`] can call it as a final
