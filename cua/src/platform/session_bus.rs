...
//!
//! AT-SPI is reached entirely over the **session** bus (see [`crate::platform::a11y`] and
//! [`crate::platform::atspi`]): the accessibility-bus launcher, every toolkit's AT-SPI
...
//! [`crate::platform::xauth`] recovers the X11 auth cookie: it prefers the standard
