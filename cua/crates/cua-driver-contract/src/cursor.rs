...
pub fn classify_cursor_semantics(name: &str, args: &Value) -> Option<CursorSemantics> {
    let action = match name {
        ...
        "launch_app" | "activate_app" | "bring_to_front" | "set_window_frame" | "close_window"
        | "minimize_window" | "maximize_window" | "restore_window" | "invoke_menu"
        ...
        | "install_ffmpeg" | "update" => CursorAction::System,
